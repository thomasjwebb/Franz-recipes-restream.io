...
module.exports = Franz => {
  ...
  function getMessages() {
    if (document.getElementsByClassName('favicon-96x96')[0].href.match('circle')) {
      let newCount = 0;

      if (document.getElementsByClassName('MuiGrid-root jss231 MuiGrid-item').length > 0) {
        newCount = document.getElementsByClassName('MuiGrid-root jss231 MuiGrid-item').length;
      }
    
      // set Franz badge
      Franz.setBadge(newCount - count);
      count = newCount;
    }
    else {
      Franz.setBadge(0);
